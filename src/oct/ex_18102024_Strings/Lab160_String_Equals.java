...
public class Lab160_String_Equals {
    public static void main(String[] args) {
       ...
       //System.out.println(s1 == s2); // false not equal locations are different
       // System.out.println(s2 == s3); // not equal referance loctions are different
       // System.out.println(s1 == s4); //true : values are same
       ...
       // How can I check the values? equals == value
        ...
        System.out.println(s3.equalsIgnoreCase(s5)); // case sensitivity removed o/p true
